        ...
        <div className="mx-auto flex h-18 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="inline-flex items-center gap-1.5 rounded-xl border border-slate-200 bg-white px-3 py-2 text-xs font-semibold text-slate-700 shadow-2xs transition hover:border-teal-300 hover:bg-teal-50/50 hover:text-teal-800 sm:px-3.5 sm:py-2.5 sm:text-sm"
              title="Telefon numaranızla talebinizi bulun"
            >
              <Search className="h-3.5 w-3.5 text-teal-600 sm:h-4 sm:w-4" />
              <span>Talebi Sorgula</span>
            </button>

            {activeJobId && (
              <Link
                href={`/ilan/${activeJobId}`}
                className="hidden sm:inline-flex items-center gap-1.5 rounded-xl border border-teal-200 bg-teal-50/80 px-3 py-2 text-xs font-bold text-teal-800 transition hover:bg-teal-100 sm:px-4 sm:py-2.5 sm:text-sm"
              >
