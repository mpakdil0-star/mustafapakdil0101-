...
const styles = StyleSheet.create({
  ...
  categoryCard: { height: 66, borderRadius: 16, backgroundColor: '#FFFFFF', paddingHorizontal: 10, flexDirection: 'row', alignItems: 'center', borderWidth: 1, borderColor: '#F1F5F9', shadowColor: '#0F172A', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.04, shadowRadius: 10, elevation: 2 },
  imageShell: { width: 40, height: 40, borderRadius: 12, alignItems: 'center', justifyContent: 'center', borderWidth: 1, marginRight: 9, overflow: 'hidden' },
  categoryImage: { width: 28, height: 28 },
  cardCopy: { flex: 1, justifyContent: 'center' },
  categoryTitle: { color: '#0F172A', fontFamily: fonts.bold, fontSize: 13, lineHeight: 17 },
  categoryDescription: { color: '#475569', fontFamily: fonts.medium, fontSize: 9.5, lineHeight: 13, marginTop: 1.5 },
  arrowButton: { width: 18, height: 18, alignItems: 'center', justifyContent: 'center' },
});
