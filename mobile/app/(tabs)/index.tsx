  ...
  return (
    <View style={[styles.container, { backgroundColor: colors.backgroundLight }]}>
      ...
      >
        ...
        {
          !isElectrician && (
            <View style={[styles.section, { paddingBottom: 10, marginTop: -20 }]}>
              <View style={{ flexDirection: 'row', marginBottom: 4, borderBottomWidth: 1, borderBottomColor: colors.borderLight }}>
                <TouchableOpacity
                  style={{ flex: 1, paddingVertical: 6, alignItems: 'center', borderBottomWidth: activeHomeTab === 'ustalar' ? 2 : 0, borderBottomColor: colors.primary }}
                ...
                <TouchableOpacity
                  style={{ flex: 1, paddingVertical: 6, alignItems: 'center', borderBottomWidth: activeHomeTab === 'ilanlar' ? 2 : 0, borderBottomColor: colors.primary }}
