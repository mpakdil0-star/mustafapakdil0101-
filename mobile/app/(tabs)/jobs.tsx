...
const styles = StyleSheet.create({
  ...
  jobGlassCard: { borderRadius: 18, padding: 14, marginBottom: 12, backgroundColor: staticColors.white, elevation: 1, overflow: 'hidden' },
  statusLine: { position: 'absolute', left: 0, top: 0, bottom: 0, width: 4 },
  cardHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 8 },
  categoryRow: { flexDirection: 'row', alignItems: 'center', gap: 6 },
  miniIconBox: { width: 28, height: 28, borderRadius: 8, justifyContent: 'center', alignItems: 'center' },
  categoryLabel: { fontFamily: fonts.extraBold, fontSize: 11, textTransform: 'uppercase', letterSpacing: 0.5 },
  jobTitleText: { fontFamily: fonts.extraBold, fontSize: 16, marginBottom: 4 },
  jobDescText: { fontFamily: fonts.medium, fontSize: 13, color: '#333333', marginBottom: 10, lineHeight: 18 },
  ...
  metaInfoText: { fontFamily: fonts.semiBold, fontSize: 12, color: '#64748B', includeFontPadding: false, textAlignVertical: 'center' },
  jobCardActions: { flexDirection: 'row', marginTop: 10, gap: 10, paddingTop: 10, borderTopWidth: 1, borderTopColor: '#F1F5F9' },
  actionBtnSmall: { flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', backgroundColor: staticColors.white, paddingVertical: 8, borderRadius: 10, borderWidth: 1, gap: 4 },
  actionBtnTextSmall: { fontFamily: fonts.bold, fontSize: 12 },
  actionBtnFull: { flex: 1, height: 42, borderRadius: 12, overflow: 'hidden' },
  actionBtnGradient: { flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 6 },
  actionBtnTextFull: { fontFamily: fonts.bold, fontSize: 13 },
  urgentGlowBadge: { borderRadius: 16, overflow: 'hidden' },
  urgentGradient: { paddingHorizontal: 6, paddingVertical: 3 },
  urgentBadgeText: { fontFamily: fonts.bold, fontSize: 10, color: staticColors.white },
  statusText: { fontFamily: fonts.bold, fontSize: 11 },
  budgetPill: { paddingHorizontal: 10, paddingVertical: 4, borderRadius: 16 },
  budgetValueText: { fontFamily: fonts.bold, fontSize: 12 },
