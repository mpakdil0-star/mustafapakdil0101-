...
const styles = StyleSheet.create({
  ...
  jobDescText: { fontFamily: fonts.medium, fontSize: 14, color: '#333333', marginBottom: 14, lineHeight: 20 },
  ...
  metaInfoText: { fontFamily: fonts.semiBold, fontSize: 13, color: '#64748B', includeFontPadding: false, textAlignVertical: 'center' },
  ...
  urgentGlowBadge: { borderRadius: 20, overflow: 'hidden' },
  ...
  budgetPill: { paddingHorizontal: 12, paddingVertical: 6, borderRadius: 20 },
