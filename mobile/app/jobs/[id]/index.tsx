...
const styles = StyleSheet.create({
  ...
  urgentBadge: { alignSelf: 'flex-start', borderRadius: 20, overflow: 'hidden', marginBottom: 12 },
  urgentGradient: { flexDirection: 'row', alignItems: 'center', paddingHorizontal: 12, paddingVertical: 6, gap: 6 },
  urgentText: { color: '#fff', fontSize: 12, fontFamily: fonts.bold },
  ...
  infoText: { fontSize: 13, fontFamily: fonts.bold, includeFontPadding: false, textAlignVertical: 'center' },
  ...
  sectionTitle: { fontSize: 16, fontFamily: fonts.semiBold, marginBottom: 10 },
  description: { fontSize: 15, fontFamily: fonts.medium, color: '#333333', lineHeight: 24, marginBottom: 20 },
  ...
  emptyBids: { alignItems: 'center', padding: 40, backgroundColor: '#F5F6FA', borderRadius: 24 },
