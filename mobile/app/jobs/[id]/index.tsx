...
const styles = StyleSheet.create({
  ...
  stepperWrapper: { marginBottom: 12, backgroundColor: staticColors.white, borderRadius: 16, padding: 6, elevation: 1 },
  mainCard: { padding: 16, borderRadius: 24, backgroundColor: staticColors.white, marginBottom: 16, elevation: 2 },
  urgentBadge: { alignSelf: 'flex-start', borderRadius: 16, overflow: 'hidden', marginBottom: 8 },
  urgentGradient: { flexDirection: 'row', alignItems: 'center', paddingHorizontal: 8, paddingVertical: 4, gap: 4 },
  urgentText: { color: '#fff', fontSize: 11, fontFamily: fonts.bold },
  headerTitleRow: { flexDirection: 'row', alignItems: 'flex-start', justifyContent: 'space-between', marginBottom: 12, gap: 8 },
  jobTitle: { fontSize: 20, fontFamily: fonts.extraBold, lineHeight: 26, flex: 1 },
  trustBadge: { flexDirection: 'row', alignItems: 'center', gap: 4, paddingHorizontal: 8, paddingVertical: 4, borderRadius: 8 },
  trustBadgeText: { fontSize: 11, fontFamily: fonts.bold },
  infoRow: { flexDirection: 'row', gap: 8, marginBottom: 12 },
  infoPill: { flexDirection: 'row', alignItems: 'center', gap: 4, paddingHorizontal: 10, paddingVertical: 4, borderRadius: 8 },
  infoText: { fontSize: 12, fontFamily: fonts.bold, includeFontPadding: false, textAlignVertical: 'center' },
  budgetBox: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', paddingHorizontal: 14, paddingVertical: 10, borderRadius: 12, marginBottom: 12 },
  budgetLabel: { fontFamily: fonts.semiBold, fontSize: 13 },
  budgetValue: { fontFamily: fonts.extraBold, fontSize: 16 },
  divider: { height: 1, backgroundColor: '#F1F5F9', marginBottom: 12 },
  sectionTitle: { fontSize: 15, fontFamily: fonts.bold, marginBottom: 8 },
  description: { fontSize: 14, fontFamily: fonts.medium, color: '#333333', lineHeight: 20, marginBottom: 16 },
  imageSection: { marginTop: 4 },
  gallery: { flexDirection: 'row' },
  galleryImage: { width: 80, height: 80, borderRadius: 12, marginRight: 8, backgroundColor: '#eee' },
  bidsSection: { marginTop: 4 },
  emptyBids: { alignItems: 'center', padding: 24, backgroundColor: '#F5F6FA', borderRadius: 16 },
  emptyBidsText: { marginTop: 8, fontFamily: fonts.medium, color: staticColors.textLight, fontSize: 13 },
  bidCard: { padding: 12, borderRadius: 16, marginBottom: 10, elevation: 1 },
  acceptedBidCard: { borderWidth: 1.5, borderRadius: 16, padding: 12, marginBottom: 12 },
  bidHeader: { flexDirection: 'row', alignItems: 'center', gap: 10 },
  bidAvatar: { width: 36, height: 36, borderRadius: 18, backgroundColor: '#eee' },
  bidInfo: { flex: 1 },
  bidName: { fontFamily: fonts.bold, fontSize: 14 },
  bidPriceBox: { paddingHorizontal: 10, paddingVertical: 4, borderRadius: 8 },
  bidPrice: { fontFamily: fonts.extraBold, fontSize: 14 },
  bidMessage: { marginTop: 8, padding: 10, backgroundColor: '#F8FAFC', borderRadius: 10, fontStyle: 'italic', color: staticColors.textSecondary, fontSize: 13 },
  bidActions: { marginTop: 12 },
  ...
  actionBtnText: { fontFamily: fonts.bold, fontSize: 12 },
  bidStatusResult: { textAlign: 'center', fontFamily: fonts.bold, color: staticColors.textLight, fontSize: 12 },
