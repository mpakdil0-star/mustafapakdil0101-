...
const SPECIALTIES_BY_CATEGORY: Record<string, { id: string; label: string; icon: string }[]> = {
    ...
    temizlik: [
        { id: 'evTemizlik', label: 'Ev Temizliği (Gündelik)', icon: 'home-outline' },
        { id: 'ofisTemizlik', label: 'Ofis ve İşyeri Temizliği', icon: 'business-outline' },
        { id: 'insaatTemizlik', label: 'İnşaat Sonrası Temizlik', icon: 'construct-outline' },
        { id: 'camTemizlik', label: 'Cam Temizliği', icon: 'albums-outline' },
        { id: 'halıTemizlik', label: 'Halı Yıkama', icon: 'bed-outline' },
        { id: 'dezenfeksiyon', label: 'Dezenfeksiyon', icon: 'shield-outline' },
    ],
    nakliyat: [
        { id: 'evdenEve', label: 'Evden Eve Nakliyat', icon: 'home-outline' },
        { id: 'ofisNakliyat', label: 'Ofis Nakliyatı', icon: 'business-outline' },
        { id: 'sehirIci', label: 'Şehir İçi Nakliyat', icon: 'car-outline' },
        { id: 'sehirDisi', label: 'Şehir Dışı Nakliyat', icon: 'airplane-outline' },
        { id: 'ambalajlama', label: 'Ambalajlama/Paketleme', icon: 'cube-outline' },
        { id: 'depolama', label: 'Depolama Hizmeti', icon: 'file-tray-stacked-outline' },
        { id: 'asansorluTasima', label: 'Asansörlü Taşıma', icon: 'swap-vertical-outline' },
    ],
    'boya-badana': [
        { id: 'icCephe', label: 'İç Cephe Boyama', icon: 'color-palette-outline' },
        { id: 'disCephe', label: 'Dış Cephe Boyama', icon: 'home-outline' },
        { id: 'badana', label: 'Badana', icon: 'brush-outline' },
        { id: 'duvarKagidi', label: 'Duvar Kağıdı', icon: 'images-outline' },
        { id: 'dekoratif', label: 'Dekoratif Boya', icon: 'sparkles-outline' },
        { id: 'alciSiva', label: 'Alçı/Sıva', icon: 'construct-outline' },
        { id: 'kartonpiyer', label: 'Kartonpiyer', icon: 'layers-outline' },
    ],
    'koltuk-hali': [
        { id: 'koltukYikama', label: 'Koltuk Yıkama', icon: 'bed-outline' },
        { id: 'haliYikama', label: 'Halı Yıkama', icon: 'grid-outline' },
        { id: 'perdeYikama', label: 'Perde Yıkama', icon: 'albums-outline' },
        { id: 'yorgandose', label: 'Yorgan/Döşek Yıkama', icon: 'moon-outline' },
        { id: 'otomobilIc', label: 'Oto İç Temizlik', icon: 'car-outline' },
        { id: 'lekecikarma', label: 'Leke Çıkarma', icon: 'water-outline' },
    ],
    'mobilya-montaj': [
        { id: 'mutfak', label: 'Mutfak Dolabı Montaj', icon: 'restaurant-outline' },
        { id: 'vestiyer', label: 'Vestiyer/Gardırop', icon: 'shirt-outline' },
        { id: 'yatak', label: 'Yatak Montajı', icon: 'bed-outline' },
        { id: 'ofis', label: 'Ofis Mobilya Montaj', icon: 'desktop-outline' },
        { id: 'raf', label: 'Raf/Askı Montajı', icon: 'layers-outline' },
        { id: 'demontaj', label: 'Demontaj/Söküm', icon: 'hammer-outline' },
    ],
    'kucuk-nakliye': [
        { id: 'tekParca', label: 'Tek Parça Eşya Taşıma', icon: 'cube-outline' },
        { id: 'buzdolabi', label: 'Buzdolabı/Çamaşır Makinesi', icon: 'snow-outline' },
        { id: 'kanepe', label: 'Kanepe/Koltuk', icon: 'bed-outline' },
        { id: 'market', label: 'Market/Toplu Alışveriş', icon: 'cart-outline' },
        { id: 'parselmoto', label: 'Motorlu Kurye', icon: 'bicycle-outline' },
    ],
    'kombi-servis': [
        { id: 'kombiBakim', label: 'Kombi Bakımı', icon: 'flame-outline' },
        { id: 'kombiTamir', label: 'Kombi Tamiri', icon: 'build-outline' },
        { id: 'kombiMontaj', label: 'Kombi Montajı', icon: 'construct-outline' },
        { id: 'petekTemizlik', label: 'Petek Temizleme', icon: 'water-outline' },
        { id: 'bacaTemizlik', label: 'Baca Temizliği', icon: 'funnel-outline' },
    ],
    asansor: [
        { id: 'asansorBakim', label: 'Periyodik Bakım', icon: 'calendar-outline' },
        { id: 'asansorTamir', label: 'Arıza Giderme', icon: 'build-outline' },
        { id: 'asansorMontaj', label: 'Asansör Montajı', icon: 'construct-outline' },
        { id: 'asansorModernizasyon', label: 'Modernizasyon', icon: 'rocket-outline' },
        { id: 'asansorKontrol', label: 'Yıllık Kontrol', icon: 'shield-checkmark-outline' },
    ],
    'bocek-ilaclama': [
        { id: 'hamam', label: 'Hamamböceği İlaçlama', icon: 'bug-outline' },
        { id: 'fare', label: 'Fare İlaçlama', icon: 'alert-circle-outline' },
        { id: 'karinca', label: 'Karınca İlaçlama', icon: 'bug-outline' },
        { id: 'sivrisinek', label: 'Sivrisinek İlaçlama', icon: 'bug-outline' },
        { id: 'tahtakurusu', label: 'Tahta Kurusu', icon: 'bed-outline' },
        { id: 'genel', label: 'Genel Haşere', icon: 'shield-outline' },
    ],
    'guvenlik-kamera': [
        { id: 'kameraMontaj', label: 'Kamera Montajı', icon: 'videocam-outline' },
        { id: 'kameraBakim', label: 'Kamera Bakım/Onarım', icon: 'build-outline' },
        { id: 'alarmSistemi', label: 'Alarm Sistemi Kurulumu', icon: 'notifications-outline' },
        { id: 'goruntuKayit', label: 'Görüntü Kayıt Sistemi', icon: 'recording-outline' },
        { id: 'uzaktanIzleme', label: 'Uzaktan İzleme', icon: 'phone-portrait-outline' },
        { id: 'kapıGiris', label: 'Kapı Giriş Sistemi', icon: 'key-outline' },
    ],
};
